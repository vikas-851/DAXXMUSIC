...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://telegra.ph/file/889edd5d19e3f9dd26a9f.jpg", caption="**ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜɪs ᴄʜᴀᴛ.**",reply_markup=buttons)
    ...
    for add_chat in chats:
        try:
            await app.send_photo(
                add_chat,
                photo="https://telegra.ph/file/889edd5d19e3f9dd26a9f.jpg",
...
async def close_nightmode():
    ...
    for rm_chat in chats:
        try:
            await app.send_photo(
                rm_chat,
                photo="https://graph.org/file/0139d212cf7cc8206c1a8.jpg",
